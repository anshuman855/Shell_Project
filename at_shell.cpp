...
int at_cd(char **args);
int at_help(char **args);
int at_exit(char **args);
int at_ls(char **args);
int at_clear(char **args);
int at_mycat(char **args);
int at_history(char **args);

char *b_str[] = {(char *)"mycd", (char *)"help", (char *)"exit", (char *)"show", (char *)"clear", (char *)"mycat", (char *)"history"};
...
{
	int i;
	cout << "\t Anshuman Tiwari\n";
	cout << " This Shell belongs to Anshuman Tiwari\n";
